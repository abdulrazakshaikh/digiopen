...
class TicketTabAuditTrail extends StatefulWidget {
  @override
  _TicketTabAuditTrailState createState() => new _TicketTabAuditTrailState();
}

class _TicketTabAuditTrailState extends State<TicketTabAuditTrail> {
