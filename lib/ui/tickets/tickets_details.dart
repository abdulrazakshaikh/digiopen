...
import 'package:xceednet/ui/tickets/cancelticket_bottomsheet.dart';
import 'package:xceednet/ui/tickets/tickettab_audittrail.dart';
import 'package:xceednet/ui/tickets/tickettab_details.dart';
...
void _onChoiceSelected(String choice) {
  showModalBottomSheet(    
    ...
    context: context, builder: (BuildContext context) { 
      return 
      choice == 'Assign Ticket' ? AssignTicketBottomSheet() :
      choice == 'Cancel Ticket' ? CancelTicketBottomSheet() :
      Container();
    }, 
  );
}
...
class Constants {
  static const String FirstItem = 'Assign Ticket';
  static const String SecondItem = 'Cancel Ticket';
