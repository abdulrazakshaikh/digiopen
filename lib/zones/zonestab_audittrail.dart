...
class ZonesTabAuditTrail extends StatefulWidget {
  @override
  _ZonesTabAuditTrailState createState() => new _ZonesTabAuditTrailState();
}

class _ZonesTabAuditTrailState extends State<ZonesTabAuditTrail> {
