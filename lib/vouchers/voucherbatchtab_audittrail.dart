...
class VoucherBatchTabAuditTrail extends StatefulWidget {
  @override
  _VoucherBatchTabAuditTrailState createState() => new _VoucherBatchTabAuditTrailState();
}

class _VoucherBatchTabAuditTrailState extends State<VoucherBatchTabAuditTrail> {
