...
class NodesTabAuditTrail extends StatefulWidget {
  @override
  _NodesTabAuditTrailState createState() => new _NodesTabAuditTrailState();
}

class _NodesTabAuditTrailState extends State<NodesTabAuditTrail> {
