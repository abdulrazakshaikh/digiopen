...
class PackageSalesList extends StatefulWidget {



  
  @override
  State<PackageSalesList> createState() => _PackageSalesListState();
}

class _PackageSalesListState extends State<PackageSalesList> {
                              ...
                              children: [
                                Expanded(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      Text('Package Sale ID : '.toLowerCase(),
                              ...
                              children: [
                                ...
                                Expanded(
                                  ...
                                  child: Column(
                                    crossAxisAlignment: CrossAxisAlignment.start,
                                    children: [
                                      Text('Location Package : '.toLowerCase(),
                                        style: GoogleFonts.roboto(
                                            textStyle: Theme.of(context).textTheme.labelMedium,
                                            letterSpacing: 1.5
                                        ),
                              ...
                              children: [
                                Expanded(
                                  ...
                                  child: Column(
                                    crossAxisAlignment: CrossAxisAlignment.start,
                                    children: [
                                      Text('Subscriber invoice : '.toLowerCase(),
                                        style: GoogleFonts.roboto(
                                            textStyle: Theme.of(context).textTheme.labelMedium,
                                            letterSpacing: 1.5
                                        ),
                                ...
                                Expanded(
                                  ...
                                  child: Column(
                                    crossAxisAlignment: CrossAxisAlignment.start,
                                    children: [
                                      Text('Total Data Used : '.toLowerCase(),
                                        style: GoogleFonts.roboto(
                                            textStyle: Theme.of(context).textTheme.labelMedium,
                                            letterSpacing: 1.5
                                        ),
