...
class InvoiceTabAuditTrail extends StatefulWidget {
  @override
  _InvoiceTabAuditTrailState createState() => new _InvoiceTabAuditTrailState();
}

class _InvoiceTabAuditTrailState extends State<InvoiceTabAuditTrail> {
